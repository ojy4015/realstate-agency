...
export const PUT = async (request, { params }) => {
  try {
    ...
    // Get property to update from the database
    ...
    // now edit the content of form
    // get the form data
    const formData = await request.formData();
    // console.log(formData.get("name")); // 'name' is name of any field

    // Access all values from amenities because they are arrays
    ...
    // update property in database (except the image)
